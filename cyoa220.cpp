...
int main()
{
	...
	StoryPage* p108 = new StoryPage(108,
		"you set pace to the monstrous mole palace.\n"
		"youre anxious about the molesociation and their evilness.\n", false);
	p108->nextPages = { 118 };
	p108->choiceText = {
		"enter the molesociation evil lair"
		
	};
	pages.push_back(p108);

	StoryPage* p118 = new StoryPage(118,
		"you entered the building.\n"
		" what next?.\n", false);
	p118->nextPages = { 128, 127 };
	p118->choiceText = {
		"go into the suspiciously large and golden bosslike door",
		"try to hide in the janitors closet"
	};
	pages.push_back(p118);

	StoryPage* p128 = new StoryPage(128,
		"you opened the giant door.\n"
		" its a bunch of food???\n", false);
	p128->nextPages = { 138 };
	p128->choiceText = {
		"explore the room"
	...
	pages.push_back(p128);

	StoryPage* p138 = new StoryPage(138,
		"a piano falls on your head.\n", true);
	pages.push_back(p138);

	StoryPage* p127 = new StoryPage(127,
		"you entered the janitors closet.\n"
		"doctor mole, doctor moleiarty and monty mole are in a top secret meeting.\n"
		"you and the moles prepare to fight eachother.\n",false);
	p127->nextPages = { 148, 137, 156 };
	p127->choiceText = {
		"you take on the moles",
		"you look for a weapon"
		"you run away"
	};
	pages.push_back(p127);


	StoryPage* p156 = new StoryPage(156,
		"a piano falls on your head(coward).\n", true);
	pages.push_back(p156);

	StoryPage* p137 = new StoryPage(137,
		"you look for a weapon.\n"
		".\n"
		"you and the moles prepare to fight eachother.\n", false);
	p137->nextPages = { 148, 137, 156 };
	p137->choiceText = {
		"you take on the moles",
		"you look for a weapon"
		"you run away"
	};
	pages.push_back(p137);
